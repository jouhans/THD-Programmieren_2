...
public class Score extends GameObject {
    ...
    public Score(GameView gameView, GamePlayManager gamePlayManager) {
        ...
        position.updateCoordinates(new Position(GameView.WIDTH/2.0 - width, 0));
    ...
    public void addToCanvas() {
        String showScore = String.format("%06d", score);
        gameView.addTextToCanvas(showScore, position.getX(), position.getY(), size, true, Color.WHITE, rotation, "pressstart2pregular.ttf");
    }
